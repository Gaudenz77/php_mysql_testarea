        ...
        //left column for titlename, right columne for values
           ...
           switch ($columnName) {
            case 'genre':
              ...
              echo "<td><select class='form-select' name='$columnName' id='genre'>
            ...
            case 'description':
              ...
              echo "<td><label for='floatingTextarea2'>Comments</label> 
                  <textarea class='form-control' type='text' id='myTextarea' name='$columnName' value='$value' style='height:110px'></textarea></td>";
              break;
            ...
            case 'currency':
              ...
              echo "<td>
                    ...
                    <input type='radio' id='html' name='$columnName' value='$value'><label for='currency'>&nbspCHF</label></td>";
              break; 
 echo "$value";
            case 'out_of_print':
              // code...
            ...
            $sql = "INSERT INTO `books`(`title`, `genre`, `author`, `description`, `publisher`,`price`, `currency`, `out_of_print`) VALUES ('[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-8]','[value-9]','[value-10]'))";
    ...
    <div class="col-sm text-center bg-info mb-2">
        <input type='submit' value='Speichern'  class="btn btn-outline-dark btn-lg" role="button">
    </div>
    </form>
    </div>
